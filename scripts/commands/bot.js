    ...
    try {
      ...
      if (!msg) {
        const greetings = [
          ...
          "─ hanga korba...!!🥲🥲",
          "─ bal falaba...!!🙂","─ হুম বাবু পরে কথা হবে এখন রাখি...!!😘🫣","─ এই তো বাবু আমি এখানে হারিয়ে জাইনি তো সোনা...!!🙈😽","─ বাবু আমাকে ডাকলে  যে কিছু বলবা বাবু...!!🤍🤭","─ না্ঁট্ঁক্ঁ ক্ঁম্ঁ ক্ঁর্ঁ পি্ঁও্ঁ...!!🫣🙈","─ ভ্ঁন্ডা্ঁমী্ঁ ছা্ঁরো্ঁ পি্ঁও্ঁ...!!🐸😒","─ অভি৯ কম করো পিও...!!🙂😾","─ মা্ঁনু্ঁষ্ঁ ক্ঁর্ঁতে্ঁ পা্ঁর্ঁলা্ঁম্ঁ না্ঁ তো্ঁদে্ঁর্ঁ....!!😒😼","","","","","","","","","",
        ];
